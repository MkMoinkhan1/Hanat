...
import { ChevronLeft, Search, Edit, Trash, Plus ,Star } from "lucide-react";
...
useEffect(() => {
  ...
  const handleTabChange = (value) => {
    ...
    router.push(`/admin/service-management/edit-service/${params.id}/category/${params.categoryid}?${newParams.toString()}`);
  ...
  useEffect(() => {
    if (defaultTab === "edit-category") {
      const categoryUrl = `/admin/service-management/edit-service/${params.id}/category/${params.categoryid}`;
