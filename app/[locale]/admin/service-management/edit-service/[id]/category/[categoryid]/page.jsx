...
export default function CategoryEditPage() {
  ...
  const t = useTranslations("ServiceManagement.CategoryPage")
  const categoryId = id
        ...
        },
 {
  ...
  const handleSave = () => {
    ...
    router.push(`/${locale}/admin/service-management/edit-service/${id}`)
  }
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="border-b bg-white">
          <Tabs value={activeTab} onValueChange={setActiveTab} className={`w-full ${direction === "rtl" ? "flex justify-end items-center" : ""}`}>
          ...
          <div className="bg-white rounded-lg border p-6">
            {activeTab === "edit-category" ? (
              ...
              <div className="relative w-full max-w-sm">
                ...
                <div>
                  <h3 className="2xl:text-sm text-xs font-medium mb-2">{t('subCategoryTab')}</h3>
                    {subcategories.length === 0 ? (
                      <p className="2xl:text-sm text-xs text-gray-500">{t('noSubCategories')}</p>
                    ) : (
                  ...
                  <div className="flex justify-between ">
                    ...
                    <div>
                      <p className="2xl:text-sm text-xs text-gray-500 mb-1">{t('avgRating')}</p>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
