          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="flex gap-2">
                <Button className="mt-6 2xl:text-sm text-xs" onClick={() => router.push(`/${locale}/admin/service-management`)}>
                Save
              </Button>
            ...
            <div className="w-full md:w-1/2">
              <div className="flex items-center justify-between mb-4">
                ...
                variant={"outline"}
                  ...
                  onClick={() => router.push(`/${locale}/admin/service-management/add-service/add-category`)}
                >
