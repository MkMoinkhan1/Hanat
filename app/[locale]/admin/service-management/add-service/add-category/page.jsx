...
export default function CategoryEditPage() {
        ...
        },
 {
  ...
  const handleSave = () => {
    ...
    router.push(`/${locale}/admin/service-management/add-service`)
  }
          ...
          <div className="bg-white rounded-lg border p-6">
            {activeTab === "edit-category" ? (
              ...
              <div className="flex items-center gap-2">
                  <Link href={`/${locale}/admin/service-management/add-service/add-category/add-sub-category?tab=sub-category`}>
