...
export default function Dashboard() {
          ...
          {activeSection === "dashboard" && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Lorem ipsum management</p>
              </div>
              </div>

              <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-5 py-6 border-y-2 border-dashed border-spacing-14">
  ...
  >
    <CardContent className="p-0 w-full px-">
      <p className="text-xs text-muted-foreground">{stat.label}</p>
      <div className="text-[24px] font-bold items-center text-primary flex flex-row gap-2">
        {stat.value}
        <div className="text-xs mt-1">
          {stat.change && (
            <span className={`${stat.color} font-medium mr-1`}>{stat.change}</span>
          )}
          <span className="text-muted-foreground">{stat.note}</span>
              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <Card className="overflow-hidden">
                  <CardHeader className="flex flex-row items-center justify-between pb-2 pt-4 px-4">
                    <div>
                      <CardTitle className="text-xs font-medium text-muted-foreground">New Users</CardTitle>
                      <div className="flex items-baseline">
                        <span className="text-2xl font-bold">48</span>
                        <span className="ml-2 text-xs font-medium text-green-500">+12 vs last week</span>
                      </div>
                    </div>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
              ...
              <div className="mt-6">
                <Card>
                  <CardContent className="p-6">
                    <h2 className="text-xl font-medium mb-4">Service Provider Management</h2>
                    <p>
                      This is the service provider section content. You can manage all your service providers from here.
                    </p>
                  </CardContent>
                </Card>
              </div>
