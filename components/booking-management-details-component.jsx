...
const BookingManagementDetailsComponent = ({bookingId}) => {
  ...
  const handleViewInvoice = () => {
    router.push(`/${locale}/admin/booking-management/${bookingId}/invoice`)
  }
  return (
  <div className="p-7">
      {/* Header */}
      <div className="mb-8">
        <div className="flex items-center gap-6 mb-4">
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => router.push(`/${locale}/admin/booking-management`)}>
...
export default BookingManagementDetailsComponent