...
const DashboardDetails = ({stats}) => {
  return (
  <div className={`grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-${stats.length} py-6 border-y-2 border-dashed border-spacing-14 mb-6`}>
                ...
                <CardContent className="p-0 w-full pr-0">
                  ...
                  <div className="text-[24px] font-[600] items-center text-primary flex flex-row gap-2">
                   ...
                   {stat.change && (
                    ...
                    >
                      {stat.label === "Overall Rating" ? (<div className='flex gap-2 item-center'><Star className="h-4 w-4 text-[#F6B51E] fill-[#F6B51E]" />{stat.change}</div>) : stat.change}
                    </span>
                  )}
