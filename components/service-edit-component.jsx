...
export default function ServiceEditComponent({ params, activePage }) {
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/2">
              <div className="flex items-center justify-between mb-4">
                <h2 className="2xl:text-lg text-sm font-medium">
                  {t("categoryList")}
                </h2>
              </div>
                ...
                {categories.map((category) => (
                  <div key={category.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-medium 2xl:text-lg text-sm">
                        {category.name}
                      </h3>
                      <Button
                        variant="default"
                    ...
                    <p className="2xl:text-sm text-xs text-gray-500 mb-2">
